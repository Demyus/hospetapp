    ...
    return (
        <div className="cursor-pointer p-3 mb-2 rounded-md group hover:bg-amber-300 border border-gray-200  shadow-md bg-white relative">
            ...
            <div className="flex ">
                ...
                <div>
                    <h2 className="truncate text-base font-bold leading-4">Nombre Apellido1 Apellido2</h2>
                    <div className="">
                        <span className="leading-4 text-sm text-slate-500">usuario@hospetal.com.mx </span>
                    </div>
                </div>
            </div>
